...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void Regist() {
        ...
        JsonObjectRequest stringRequest = new JsonObjectRequest(Request.Method.POST, URL_REGIST + "/add/user", js,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        if (response != null) {
                            ...
                            startActivity(new Intent(RegisterActivity.this, ParseTest.class)); //Go to parse test
                        } else {
